<template>
  <!-- error notification -->
  <div
    class="alert text-white bg-red-600 absolute top-1 right-1 rounded-lg z-50 px-4 py-2"
    x-transition.duration.300ms
    v-if="errors"
  >
    <span class="text-3xl"
      ><i class="fa fa-warning text-xl">{{ errors }}</i></span
    >
  </div>
  ...
  >
    <div
      class="w-full max-w-md space-y-8 bg-white py-16 px-12 rounded-lg drop-shadow-2xl"
    >
      <div>
        <h2
